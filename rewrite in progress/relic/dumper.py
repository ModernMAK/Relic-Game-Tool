...
from relic.sga import __safe_makedirs, write_file_as_binary, walk_archive_paths, \
    walk_sparse_archives, walk_archive_files, filter_archive_files_by_extension, collapse_walk_in_files
...
def unpack_stream(stream: BinaryIO, chunk_format: ChunkyFormat) -> AbstractRelicChunky:
    chunky = RelicChunky._unpack(stream)
...
def quick_dump(out_dir: str, input_folder: str = None, ext_whitelist: KW_LIST = None,
    ...
    walk = walk_sparse_archives(walk)
