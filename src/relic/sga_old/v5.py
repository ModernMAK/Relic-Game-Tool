...
from relic.sga_old import v2
from relic.sga_old.abc_old_ import VirtualDriveHeaderABC, FolderHeaderABC, FileHeaderABC, ArchiveHeaderABC, ArchiveABC, ArchiveTableOfContentsHeadersABC
from relic.sga_old.checksums import validate_md5_checksum
from relic.sga_old.common import ArchiveVersion
from relic.sga_old.v2 import ArchiveToCPtrABC
from relic.sga_old import abc_old_
from relic.sga_old.vX import APIvX

version = None # ArchiveVersion.v5
