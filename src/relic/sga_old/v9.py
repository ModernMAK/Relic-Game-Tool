...
from relic.sga_old.abc_old_ import VirtualDriveHeaderABC, ArchiveToCPtrABC, FolderHeaderABC, FileHeaderABC, ArchiveABC, ArchiveHeaderABC, ArchiveTableOfContentsHeadersABC, NameBufferABC
...
version =None #  ArchiveVersion.v9
